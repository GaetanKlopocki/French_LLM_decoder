...
**A pre-trained model is available for inference testing.** It was trained for 60,000 epochs (~15 hours on a T4 Colab GPU). The model is accessible on Hugging Face: [GaetanKlopocki/French_LLM_decoder](https://huggingface.co/GaetanKlopocki/French_LLM_decoder).
